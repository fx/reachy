...
#   upstream-path:    tests/unit/test_satellite.py
...
from esphome_test_support import make_satellite, make_state
...
class TestInit:
    ...
    def test_mute_switch_entity_created(self, tmp_path):
        from reachy_mini_ha_satellite.esphome.entity import MuteSwitchEntity
    ...
    def test_thinking_sound_entity_created(self, tmp_path):
        from reachy_mini_ha_satellite.esphome.entity import ThinkingSoundEntity
    ...
    def test_mic_gain_entity_created(self, tmp_path):
        from reachy_mini_ha_satellite.esphome.entity import MicSettingEntity
