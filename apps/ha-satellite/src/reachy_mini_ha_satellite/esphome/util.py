...
#   upstream-path:    linux_voice_assistant/util.py
...
def get_default_interface():
    ...
    # default_gateway is e.g. {InterfaceType.AF_INET: ('192.0.2.1', 'wlp0s20f3')}
...
def get_default_ipv4(interface: str):
    ...
    ipv4_info = addresses.get(netifaces.AF_INET)  # type: ignore[call-overload]  # netifaces2 ships no stubs, so the key type is unknown
