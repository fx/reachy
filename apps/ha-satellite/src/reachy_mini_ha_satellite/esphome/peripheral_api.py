...
#   upstream-path:    linux_voice_assistant/peripheral_api.py
...
class PeripheralAPIServer:
    ...
    async def start(self) -> None:
        ...
        try:
            from websockets.server import serve  # type: ignore[import,attr-defined]  # re-exported through a module __getattr__, which mypy cannot see
        except ImportError:
